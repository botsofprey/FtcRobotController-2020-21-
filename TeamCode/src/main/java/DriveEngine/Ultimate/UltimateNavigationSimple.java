...
public class UltimateNavigationSimple {
    ...
    private double maxTurnRPS = 0;
    private static final double DRIVE_BASE_DIAMETER_INCHES = 18;
    ...
    public UltimateNavigationSimple(HardwareMap hw, String configFile){
        ...
        maxTurnRPS = driveMotors[FRONT_LEFT_HOLONOMIC_DRIVE_MOTOR].getMaxSpeed() / (Math.PI * DRIVE_BASE_DIAMETER_INCHES);
    }

    public UltimateNavigationSimple(HardwareMap hw, Location startLocation, String configFile){
        this(hw, configFile);
        robotLocation = startLocation;
    }

    public UltimateNavigationSimple(HardwareMap hw, Location startLocation, double robotOrientationOffset, String configFile){
        this(hw, configFile);
        orientation.setOrientationOffset(robotOrientationOffset);
        robotLocation = startLocation;
    }

    public UltimateNavigationSimple(HardwareMap hw, double robotOrientationOffset, String configFile){
        this(hw, configFile);
        orientation.setOrientationOffset(robotOrientationOffset);
    }
    ...
    /**
     * turns the robot to face a desired heading within a given amount of tolerance
     * @param heading heading to orient to from -180 to 180
     * @param percentOfMaxTurnRate value from -1 to 1 corresponding to the max turn rate
    ...
    /**
     * turns the robot to face a desired heading using a PID control
     * @param heading heading to orient to from -180 to 180
     * @param percentOfMaxTurnRate value from -1 to 1 corresponding to the max turn rate
     * @param mode LinearOpMode corresponding to the running op mode
     */
    ...
    /**
     * turns the robot to face a desired heading within a specified amount of tolerance using a PID control
     * @param heading heading to orient to from -180 to 180
     * @param percentOfMaxTurnRate value from -1 to 1 corresponding to the max turn rate
     * @param tolerance the acceptable +/- error for the robot to orient within
     * @param mode LinearOpMode corresponding to the running op mode
